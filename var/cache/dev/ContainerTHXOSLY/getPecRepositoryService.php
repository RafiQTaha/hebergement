 ...
 */
class getPecRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PecRepository' shared autowired service.
     *
     * @return \App\Repository\PecRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PecRepository.php';

        return $container->privates['App\\Repository\\PecRepository'] = new \App\Repository\PecRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
