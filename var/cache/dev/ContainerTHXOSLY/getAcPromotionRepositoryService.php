 ...
 */
class getAcPromotionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcPromotionRepository' shared autowired service.
     *
     * @return \App\Repository\AcPromotionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcPromotionRepository.php';

        return $container->privates['App\\Repository\\AcPromotionRepository'] = new \App\Repository\AcPromotionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
