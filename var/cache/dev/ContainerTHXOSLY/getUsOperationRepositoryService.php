 ...
 */
class getUsOperationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UsOperationRepository' shared autowired service.
     *
     * @return \App\Repository\UsOperationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UsOperationRepository.php';

        return $container->privates['App\\Repository\\UsOperationRepository'] = new \App\Repository\UsOperationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
