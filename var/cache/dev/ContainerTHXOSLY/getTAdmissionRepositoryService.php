 ...
 */
class getTAdmissionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TAdmissionRepository' shared autowired service.
     *
     * @return \App\Repository\TAdmissionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TAdmissionRepository.php';

        return $container->privates['App\\Repository\\TAdmissionRepository'] = new \App\Repository\TAdmissionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
