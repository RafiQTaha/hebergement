 ...
 */
class getPSituationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PSituationRepository' shared autowired service.
     *
     * @return \App\Repository\PSituationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PSituationRepository.php';

        return $container->privates['App\\Repository\\PSituationRepository'] = new \App\Repository\PSituationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
