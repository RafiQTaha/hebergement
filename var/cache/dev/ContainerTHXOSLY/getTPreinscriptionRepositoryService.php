 ...
 */
class getTPreinscriptionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TPreinscriptionRepository' shared autowired service.
     *
     * @return \App\Repository\TPreinscriptionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TPreinscriptionRepository.php';

        return $container->privates['App\\Repository\\TPreinscriptionRepository'] = new \App\Repository\TPreinscriptionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
