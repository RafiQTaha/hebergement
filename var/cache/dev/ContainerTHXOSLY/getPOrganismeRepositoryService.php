 ...
 */
class getPOrganismeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\POrganismeRepository' shared autowired service.
     *
     * @return \App\Repository\POrganismeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'POrganismeRepository.php';

        return $container->privates['App\\Repository\\POrganismeRepository'] = new \App\Repository\POrganismeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
