 ...
 */
class getAcSemestreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcSemestreRepository' shared autowired service.
     *
     * @return \App\Repository\AcSemestreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcSemestreRepository.php';

        return $container->privates['App\\Repository\\AcSemestreRepository'] = new \App\Repository\AcSemestreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
