 ...
 */
class getTInscriptionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TInscriptionRepository' shared autowired service.
     *
     * @return \App\Repository\TInscriptionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TInscriptionRepository.php';

        return $container->privates['App\\Repository\\TInscriptionRepository'] = new \App\Repository\TInscriptionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
