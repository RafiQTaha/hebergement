 ...
 */
class getPFraisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PFraisRepository' shared autowired service.
     *
     * @return \App\Repository\PFraisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PFraisRepository.php';

        return $container->privates['App\\Repository\\PFraisRepository'] = new \App\Repository\PFraisRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
