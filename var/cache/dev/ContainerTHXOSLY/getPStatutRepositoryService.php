 ...
 */
class getPStatutRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PStatutRepository' shared autowired service.
     *
     * @return \App\Repository\PStatutRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PStatutRepository.php';

        return $container->privates['App\\Repository\\PStatutRepository'] = new \App\Repository\PStatutRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
