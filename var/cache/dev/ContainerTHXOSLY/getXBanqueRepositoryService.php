 ...
 */
class getXBanqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\XBanqueRepository' shared autowired service.
     *
     * @return \App\Repository\XBanqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'XBanqueRepository.php';

        return $container->privates['App\\Repository\\XBanqueRepository'] = new \App\Repository\XBanqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
