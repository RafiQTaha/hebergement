 ...
 */
class getTOperationcabRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TOperationcabRepository' shared autowired service.
     *
     * @return \App\Repository\TOperationcabRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TOperationcabRepository.php';

        return $container->privates['App\\Repository\\TOperationcabRepository'] = new \App\Repository\TOperationcabRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
