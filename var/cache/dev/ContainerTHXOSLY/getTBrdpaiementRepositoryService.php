 ...
 */
class getTBrdpaiementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TBrdpaiementRepository' shared autowired service.
     *
     * @return \App\Repository\TBrdpaiementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TBrdpaiementRepository.php';

        return $container->privates['App\\Repository\\TBrdpaiementRepository'] = new \App\Repository\TBrdpaiementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
