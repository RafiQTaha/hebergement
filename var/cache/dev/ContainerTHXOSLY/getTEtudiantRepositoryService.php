 ...
 */
class getTEtudiantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TEtudiantRepository' shared autowired service.
     *
     * @return \App\Repository\TEtudiantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TEtudiantRepository.php';

        return $container->privates['App\\Repository\\TEtudiantRepository'] = new \App\Repository\TEtudiantRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
