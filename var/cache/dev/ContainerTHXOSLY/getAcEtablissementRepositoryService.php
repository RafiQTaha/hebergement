 ...
 */
class getAcEtablissementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcEtablissementRepository' shared autowired service.
     *
     * @return \App\Repository\AcEtablissementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcEtablissementRepository.php';

        return $container->privates['App\\Repository\\AcEtablissementRepository'] = new \App\Repository\AcEtablissementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
