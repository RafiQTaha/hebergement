 ...
 */
class getNatureDemandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NatureDemandeRepository' shared autowired service.
     *
     * @return \App\Repository\NatureDemandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NatureDemandeRepository.php';

        return $container->privates['App\\Repository\\NatureDemandeRepository'] = new \App\Repository\NatureDemandeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
