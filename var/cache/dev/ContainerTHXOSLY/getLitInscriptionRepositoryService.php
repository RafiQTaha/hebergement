 ...
 */
class getLitInscriptionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LitInscriptionRepository' shared autowired service.
     *
     * @return \App\Repository\LitInscriptionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LitInscriptionRepository.php';

        return $container->privates['App\\Repository\\LitInscriptionRepository'] = new \App\Repository\LitInscriptionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
