 ...
 */
class getAcAnneeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcAnneeRepository' shared autowired service.
     *
     * @return \App\Repository\AcAnneeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcAnneeRepository.php';

        return $container->privates['App\\Repository\\AcAnneeRepository'] = new \App\Repository\AcAnneeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
