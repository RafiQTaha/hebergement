 ...
 */
class getPBatimentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PBatimentsRepository' shared autowired service.
     *
     * @return \App\Repository\PBatimentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PBatimentsRepository.php';

        return $container->privates['App\\Repository\\PBatimentsRepository'] = new \App\Repository\PBatimentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
