 ...
 */
class getUsSousModuleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UsSousModuleRepository' shared autowired service.
     *
     * @return \App\Repository\UsSousModuleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UsSousModuleRepository.php';

        return $container->privates['App\\Repository\\UsSousModuleRepository'] = new \App\Repository\UsSousModuleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
