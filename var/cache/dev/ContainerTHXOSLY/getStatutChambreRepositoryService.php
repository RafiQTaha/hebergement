 ...
 */
class getStatutChambreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StatutChambreRepository' shared autowired service.
     *
     * @return \App\Repository\StatutChambreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StatutChambreRepository.php';

        return $container->privates['App\\Repository\\StatutChambreRepository'] = new \App\Repository\StatutChambreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
