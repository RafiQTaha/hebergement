 ...
 */
class getTOperationdetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TOperationdetRepository' shared autowired service.
     *
     * @return \App\Repository\TOperationdetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TOperationdetRepository.php';

        return $container->privates['App\\Repository\\TOperationdetRepository'] = new \App\Repository\TOperationdetRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
