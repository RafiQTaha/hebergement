 ...
 */
class getAcDepartementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AcDepartementRepository' shared autowired service.
     *
     * @return \App\Repository\AcDepartementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AcDepartementRepository.php';

        return $container->privates['App\\Repository\\AcDepartementRepository'] = new \App\Repository\AcDepartementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
