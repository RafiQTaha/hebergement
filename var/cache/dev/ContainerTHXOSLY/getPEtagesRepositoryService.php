 ...
 */
class getPEtagesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PEtagesRepository' shared autowired service.
     *
     * @return \App\Repository\PEtagesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PEtagesRepository.php';

        return $container->privates['App\\Repository\\PEtagesRepository'] = new \App\Repository\PEtagesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
