 ...
 */
class getMouchardRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MouchardRepository' shared autowired service.
     *
     * @return \App\Repository\MouchardRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MouchardRepository.php';

        return $container->privates['App\\Repository\\MouchardRepository'] = new \App\Repository\MouchardRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
