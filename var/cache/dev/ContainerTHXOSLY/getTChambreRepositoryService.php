 ...
 */
class getTChambreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TChambreRepository' shared autowired service.
     *
     * @return \App\Repository\TChambreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TChambreRepository.php';

        return $container->privates['App\\Repository\\TChambreRepository'] = new \App\Repository\TChambreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
