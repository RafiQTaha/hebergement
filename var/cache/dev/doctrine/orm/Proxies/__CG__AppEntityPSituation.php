 ...
 */
class PSituation extends \App\Entity\PSituation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\PSituation' . "\0" . 'id', '' . "\0" . 'App\\Entity\\PSituation' . "\0" . 'designation', '' . "\0" . 'App\\Entity\\PSituation' . "\0" . 'abreviation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PSituation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDesignation(?string $designation): \App\Entity\PSituation
    {
     ...
     * {@inheritDoc}
     */
    public function setAbreviation(?string $abreviation): \App\Entity\PSituation
    {
