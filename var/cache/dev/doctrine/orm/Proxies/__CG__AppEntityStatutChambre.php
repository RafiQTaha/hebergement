 ...
 */
class StatutChambre extends \App\Entity\StatutChambre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\StatutChambre' . "\0" . 'id', '' . "\0" . 'App\\Entity\\StatutChambre' . "\0" . 'designation', '' . "\0" . 'App\\Entity\\StatutChambre' . "\0" . 'abreviation', '' . "\0" . 'App\\Entity\\StatutChambre' . "\0" . 'chambres', '' . "\0" . 'App\\Entity\\StatutChambre' . "\0" . 'active'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatutChambre $proxy) {
