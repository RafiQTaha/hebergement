...
class UsSousModule extends \App\Entity\UsSousModule implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'id', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'link', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'icon', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'designation', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'class', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'prefix', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'module', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'operations', '' . "\0" . 'App\\Entity\\UsSousModule' . "\0" . 'ordre'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIcon(?string $icon): \App\Entity\UsSousModule
    {
     ...
     * {@inheritDoc}
     */
    public function setClass(?string $class): \App\Entity\UsSousModule
    {
