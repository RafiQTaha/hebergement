...
#[Route('administrateur/synchronisation')]
class SynchronisationController extends AbstractController
{
    ...
    #[Route('/synchronisation', name: 'synchronisation', options: ['expose' => true])]
    public function synchronisation(Request $request): Response
    {
        // dd(ini_get('max_execution_time'));
        $operations = $this->api->check($this->getUser(), 'synchronisation', $this->em, $request);
        if (!$operations) {
            return new AccessDeniedException();
        }
        return $this->render('administrateur/synchronisation/synchronisation.html.twig', [
