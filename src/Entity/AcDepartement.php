...
use App\Repository\AcDepartementRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: AcDepartementRepository::class)]
class AcDepartement
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'departement', targetEntity: PEtages::class)]
    ...
    public function removePEtage(PEtages $pEtage): static
    {
        if ($this->pEtages->removeElement($pEtage)) {
            ...
            if ($pEtage->getDepartement() === $this) {
                $pEtage->setDepartement(null);
            }
        }
