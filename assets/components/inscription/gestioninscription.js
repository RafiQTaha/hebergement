const Toast = Swal.mixin({
    ...
    var table = $("#datatables_gestion_inscription").DataTable({
        ...
        order: [[0, "desc"]],
        ajax: "/facturaction/inscription/list",
        processing: true,
        serverSide: true,
        deferRender: true,
        responsive: true,
    ...
    const getStatutInscription = async () => {
        ...
        try {
            ...
            const request = await axios.get("/facturaction/inscription/getstatut/"+id_inscription);
    ...
    const getFrais = async () => {
        try {
            const request = await axios.get("/facturaction/inscription/frais/"+id_inscription);
            const data = await request.data;
            facture_exist = 1;
    ...
    const getInscriptionInfos = async () => {
        try {
            ...
            const request = await axios.get("/facturaction/inscription/info/"+id_inscription);
            const data = await request.data;
    ...
    $("#save_frais_gestion").on("click", async () => {
        ...
        try {
          const request = await axios.post('/facturaction/inscription/addfrais/'+id_inscription, formData);
          ...
          frais = [];
          window.open("/facturaction/inscription/facture/"+response, '_blank');
    ...
    $("#statut_save").on("submit", async function (e){
        ...
        try {
          const request = await axios.post('/facturaction/inscription/updatestatut/'+id_inscription, formData);
          const response = request.data;
    ...
    $('body').on('click','#extraction', function (){
        window.open('/facturaction/inscription/extraction_ins', '_blank');
    })
    ...
    $('body').on('click','#export_inscription',function (e) {
        ...
        // alert(annee);
        window.open('/facturaction/inscription/extraction_ins_annee/'+annee, '_blank');
    });
